...
handle_date_picker_fields = function(){
  $('.datepicker').datepicker({
    dateFormat: translations.date_picker,
    dayNames: translations.abbr_day_names,
    dayNamesMin: translations.abbr_day_names,
    firstDay: translations.first_day,
    monthNames: translations.month_names,
    prevText: translations.previous,
...
$(document).ready(function(){
  ...
  window.advanceOrder = function() {
      $.ajax({
          ...
          url: url(routes.checkouts_api + "/" + order_number + "/advance")
      }).done(function() {
