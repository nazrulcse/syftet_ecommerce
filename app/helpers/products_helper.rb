module ProductsHelper
  ...
  def product_description(product)
    ...
    description.blank? ? t(:product_has_no_description) : raw(description)
  end
  ...
  def available_status(product) # will return a human readable string
    return t(:discontinued) if product.discontinued?
    return t(:deleted) if product.deleted?
