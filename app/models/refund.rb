class Refund < Base
  ...
  belongs_to :reason, class_name: 'RefundReason', foreign_key: :refund_reason_id
  ...
  def money
    Money.new(amount, {currency: payment.currency})
  end
  ...
  def perform!
    ...
    credit_cents = Money.new(amount.to_f, currency: payment.currency).money.cents
