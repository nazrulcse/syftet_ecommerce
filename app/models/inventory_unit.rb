class InventoryUnit < Base
  ...
  with_options inverse_of: :inventory_units do
    ...
    belongs_to :shipment, class_name: "Shipment", touch: true
    belongs_to :return_authorization, class_name: "ReturnAuthorization"
    belongs_to :line_item, class_name: "LineItem"
  end

  has_many :return_items, inverse_of: :inventory_unit
  has_one :original_return_item, class_name: "ReturnItem", foreign_key: :exchange_inventory_unit_id
