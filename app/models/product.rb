...
class Product < Base
  ...
  with_options presence: true do
    ...
    validates :price, if: proc { true } #Config[:require_master_price] } TODO: activate config
  end
...
#    super || TaxCategory.find_by(is_default: true) TODO: Need to enabled tax
  ...
  def empty_option_values?
    ...
    #opt.option_type.option_values.empty? TODO: Need to enabled this line
    #end
  end
...
require_dependency 'product/scopes'