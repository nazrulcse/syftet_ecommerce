module PermittedAttributes
  ...
  @@address_attributes = [
      ...
      :address1, :address2, :city, :country_id, :state_id, :country, :state,
  ...
  @@checkout_attributes = [
      :coupon_code, :email, :shipping_method_id, :special_instructions, :use_billing, :collection_point
  ]
  ...
  @@user_attributes = [:email, :password, :password_confirmation, :user_type, role_ids: []]
